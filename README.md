...
1. 갖다드림
  ...
  설계/개발 : 메인 기능은 각 사용자가 서비스를 등록 및 수행하는것이 목표  
  심부름을 Peer To Peer 아키텍처로 구현하였으며 사용자가 서비스를 제공및 요청 모두가 가능한 어플리케이션  
  각 사용자는 자신이 원하는 바를 게시판에 게시할수 있으며 다른사람이 게시판에 등록한 서비스를 제공  
  서비스에대한 즉각적인 사용자들의 피드백을 위해 사용자간의 대화창 제공
  
  어플리케이션 실행 영상: https://www.youtube.com/watch?v=jB9QAhMm0tQ
2. 이어폰 알람
3. 미니쉘
4. 축구선수 DB
